...
const services = [
  ...
  },
  {
    ...
    aboutBody_ar: 'الحمّام المغربي من أعرق طقوس العناية في المنطقة. نُؤدّيه كما يجب أن يُؤدَّى — صابون أسود، بخار، تقشير بكيس الكسة، قناع، وانتهاء بزيت الأرجان. متوفّر في بيوت السبا (بني ياس سبا، VIP المرور).',
    treatments: [
      { name: 'حمّام مغربي', desc: 'بخار، صابون أسود، تقشير كامل، قناع مرطّب.', price: 'ابتداءً من ١٣٠ درهم' },
      { name: 'حمّام مغربي خاص', desc: 'الطقس المغربي الكامل في جناح علاج خاص.', price: 'ابتداءً من ١٨٠ درهم' },
      { name: 'حمّام مغربي ملكي', desc: 'الطقس الكامل مع علاج بزيت أرجان ومساج رأس.', price: 'ابتداءً من ٣٠٠ درهم' }
    ],
    ritual: [
